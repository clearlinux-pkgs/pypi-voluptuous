...
Source0  : https://files.pythonhosted.org/packages/9d/81/01a869fbe01ce20f84a974b3fca1d152fade3551c92bb9d11fd74ed5e3a9/voluptuous-0.14.0.tar.gz
...
%prep
%setup -q -n voluptuous-0.14.0
cd %{_builddir}/voluptuous-0.14.0
pushd ..
cp -a voluptuous-0.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699897962
